    ...
    case MQTT_EVENT_DATA :
        ...
        if (topic_buffer != NULL) {
            ...
            if (data_buffer != NULL) {
                ...
                // zovi callback funkciju ovisno o aplikaciji ili
                // stavi poruku u neki queue za poruke još bolje
...
{
    // zadnji argument je QoS = 0, dakle bez potvrde
